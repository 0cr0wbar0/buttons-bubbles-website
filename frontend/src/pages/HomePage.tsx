...
export default function HomePage() {
  return (
    <div className="relative z-10">
      ...
      >
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <Link to="/get-involved" className="btn-secondary-inverted">
            Book a Session
          </Link>
          <Link to="/get-involved#donate" className="btn-secondary-inverted">
            Donate
          </Link>
          <Link to="/contact" className="btn-primary-inverted">
            Contact Us
          </Link>
        </div>
      </Section>
