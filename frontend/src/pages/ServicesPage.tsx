      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <p className="mt-4 text-foreground/90 leading-relaxed">
            ...
            exist. It's the imaginative heart of everything we do. Home to our bespoke characters. Designed so everyone belongs by default, not as an afterthought.
          </p>
          <p className="mt-4 text-foreground/90 leading-relaxed">
